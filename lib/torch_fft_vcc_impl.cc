...
torch_fft_vcc::sptr torch_fft_vcc::make(unsigned int fft_len, unsigned int device_num) {
    return gnuradio::make_block_sptr<torch_fft_vcc_impl>(fft_len, device_num);
}

/*
 * The private constructor
 */
torch_fft_vcc_impl::torch_fft_vcc_impl(unsigned int fft_len, unsigned int device_num)
    : gr::sync_block(
          "torch_fft_vcc",
 ...
 */
torch_fft_vcc_impl::~torch_fft_vcc_impl() {}

int torch_fft_vcc_impl::work(
    int noutput_items,
