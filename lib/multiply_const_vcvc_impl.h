...
class multiply_const_vcvc_impl : public multiply_const_vcvc
{
private:
...
public:
    multiply_const_vcvc_impl(const std::vector<gr_complex>& constant, unsigned int device_num);
    ~multiply_const_vcvc_impl();
